...
*Label aggInd year
*label var extPoorCt`year' "Count of Extreme Poor `year'" 
*label var costSolvePov`year' "Cost to Solve Poverty (Perf. Targ.) `year'"
*label var SN_ITK_DEFCN`year' "Count of Undernourished `year'"
*label var HfinGap`year' "Health Financing Gap"
*label var EfinGap`year' "Education Financing Gap"
*label var illiterate`year' "Count of Illiterate"
*label var GI`year' "UN HDI Gender Ineq."
*label var WBLIndex "Women Business and the Law Index"
*label var noSafeWater "Count Without Safe Drinking Water"
*label var noSafeSan "Count Without Safe Sanitation"
*label var noElec "Count Without Electricity"
*label var unemployedCt "Count of Unemployed"
*label var TfinGap "Transport Financing Gap"
*label var EnfinGap "Energy Financing Gap"
*label var si_pov_gini "Gini Index"
*label var uSlumPop "Urban Slum Population"
*label var VC_DSR_GDPLS "Economic Loss to Disasters"
*label var co2pgdp "CO2 per unit of GDP"
*label var NRenShare "Share Non-renewable Energy"
*label var PMrnPGap "Marine Protected Areas Percentage Gap"
*label var PLandPGap "Protected Land Percentage Gap"
*label var PLandGap "Protected Land Gap"
*label var vc_idp_tocv "Internally Displaced Persons (Violence)"
*label var NPSI "Public Sector and Institutions Need"
*label var NRM "Revenue Mobilization Need"
*label var NSCS "Statistical Capacity Need"
...
capture: xtreg ais`indicator' ns`indicator' polity2 NPSI, fe vce(cluster rName)
capture: eststo winstpfe`indicator'
capture: xtreg ais`indicator' ns`indicator' polity2 NPSI NRM, fe vce(cluster rName)
capture: eststo winstdrmfe`indicator'
capture: esttab ncols`indicator' p2ols`indicator' pfe`indicator' winstpfe`indicator' winstdrmfe`indicator' using "regs`indicator'.rtf", label replace compress
eststo clear
}
...
capture: xtreg avgais avgns polity2, fe vce(cluster rName)
capture: eststo avgpfe
capture: xtreg avgais avgns polity2 NPSI, fe vce(cluster rName)
capture: eststo avgwinstpfe
capture: xtreg avgais avgns polity2 NPSI NRM, fe vce(cluster rName)
capture: eststo avgwinstdrmfe
capture: esttab avgncols avgp2ols avgpfe avgwinstpfe avgwinstdrmfe using "avgregs.rtf", label replace compress
