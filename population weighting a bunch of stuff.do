...
label var NPSI "WGI Public Sector/Institutions score"
label var NRM "WGI Revenue Mobilization Score"
...
capture: esttab ncols`indicator' p2ols`indicator' winstp`indicator' winstdrm`indicator' using "regs`indicator'.rtf", label replace compress
eststo clear
}
